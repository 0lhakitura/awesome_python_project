...
class TextRecordsProvider:
    def __init__(self, input_filename="provided_records.txt"):
        self.input_filename = input_filename

    def get_records_from_text_file(self):
        try:
            with open(self.input_filename, "r") as text_file:
                records_data = text_file.readlines()
            return records_data
        except FileNotFoundError:
            print(f"Text file '{self.input_filename}' not found.")
            return None
...
class RecordsProcessor:
    ...
    def process_text_file(self):
        text_provider = TextRecordsProvider(self.get_file_path())
        records_data = text_provider.get_records_from_text_file()
    ...
    def process_json_file(self):
        json_provider = JSONRecordsProvider.get_file_path()
        records_data = json_provider.get_records_from_json()
    ...
    def process_xml_file(self):
        xml_provider = XMLRecordsProvider(self.get_file_path())
        records_data = xml_provider.get_records_from_xml()
...
if __name__ == "__main__":
    ...
    # records_app = RecordsProcessor()
    # records_app.process_user_inputs()

    # file_path = "provided_records.txt"
    # num_records = int(input("Enter the number of records to process: "))
    # record_provider = RecordsProcessor()
    # record_provider.process_text_file()
    records_json = RecordsProcessor()
    records_json.process_json_file()
    # records_xml = RecordsProcessor()
    # records_xml.process_xml_file()
